...
class Profile
{
    public static function ChangeData()
    {
        ...
        $result = $conn->query("SELECT * FROM `student` WHERE ID = $user_id");
        $rows = "";
        if (mysqli_num_rows($result) > 0) {
            ...
            $rows .= "<div class=\"form-input\"><form  action=\"/change\" class=\"sign-up-form\" style=\"item-align:center; margin-left:200px; margin-right:200px\" method=\"POST\">
            <div class=\"form-input\"><input type=\"text\" name=\"name\" id=\"name\" placeholder=\"$name\" ></div>
            <div class=\"form-input\"><input type=\"text\" name=\"surname\" id=\"surname\" placeholder=\"$surname\" ></div>
            <div class=\"form-input\"><input type=\"tel\" name=\"phone\" id=\"phone\" placeholder=\"$phone\" pattern=\"[0-9]{9}\" ></div>
            <div class=\"form-input\"><input type=\"email\" name=\"email\" id=\"email\" placeholder=\"$email\" ></div>
            <br><hr>
            <div class=\"form-input\"><input type=\"text\" name=\"city\" id=\"city\" placeholder=\"$city\" ></div>
            <div class=\"form-input\"><input type=\"text\" name=\"street\" id=\"street\" placeholder=\"$street\" ></div>
            <div class=\"form-input\"><input type=\"text\" name=\"local\" id=\"local\" placeholder=\"$local\" ></div>
            <div class=\"form-input\"> <input type=\"text\" name=\"zip\" id=\"zip\" placeholder=\"$zip\" pattern-\"[0-9]{2}-[0-9]{3}\" ></div>
            <button class=\"submit-btn\" type=\"submit\" value=\"Zapisz dane\" name=\"Zapisz dane\">Zapisz dane</button></div>";
