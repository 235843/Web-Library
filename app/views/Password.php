...
class Password
{
    public static function ChangePassword()
    {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $rows .= "<div class=\"form-input\"><form  action=\"/changepassword\" class=\"sign-up-form\" style\"item-align:center;\" method=\"POST\">
            <h2>Zmiana hasła<h2>
            <div class=\"form-input\"><input type=\"password\" name=\"password\" id=\"password\" placeholder=\"Stare hasło\" required ></div>
            <div class=\"form-input\"><input type=\"password\" name=\"newpassword\" id=\"newpassword\" placeholder=\"Nowe hasło\" required></div>
            <div class=\"form-input\"><input type=\"password\" name=\"passwordconf\" id=\"passwordconf\" placeholder=\"Powtórz hasło\" required ></div>
            
            
            <button class=\"submit-btn\" type=\"submit\" value=\"Zapisz dane\" name=\"Zapisz dane\">Zmień</button></div>";
