...
class AddBook
{
    public static function AddBook()
    {
        ...
        $rows = "<div class=\"form-input\"><form  action=\"/added\" class=\"sign-up-form\" style\"item-align:center;\" method=\"POST\">
        <h2>Dodaj Pozycję<h2>
        <div class=\"form-input\"><input type=\"text\" name=\"title\" id=\"title\" placeholder=\"Tytuł\" required ></div>
        <div class=\"form-input\"><input type=\"text\" name=\"author\" id=\"author\" placeholder=\"Autor\" required></div>
        <div class=\"form-input\"><input type=\"text\" name=\"amount\" id=\"amount\" placeholder=\"Ilość\" required ></div>
        <div class=\"form-input\"><input type=\"text\" name=\"descr\" id=\"descr\" placeholder=\"Opis\" required ></div>
        <div class=\"form-input\"><input type=\"text\" name=\"category\" id=\"category\" placeholder=\"Kategoria\" required ></div>
        <button class=\"submit-btn\" type=\"submit\" value=\"Dodaj\" name=\"Dodaj\">Dodaj</button></div></div>";
